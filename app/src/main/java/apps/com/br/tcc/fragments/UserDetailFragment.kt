...
class UserDetailFragment : Fragment() {
    ...
    private val PROFILE_ICON_BASE_URL = "http://ddragon.leagueoflegends.com/cdn/8.14/img/profileicon/"
    private val CHAMPION_IMAGE_BASE_URL = "http://ddragon.leagueoflegends.com/cdn/img/champion/splash/"
    private val CHAMPION_PROFILE_ICON = "http://ddragon.leagueoflegends.com/cdn/8.14/img/champion/"
    private val ITEM_BASE_URL = "http://ddragon.leagueoflegends.com/cdn/8.14/img/item/"

    private val apiKey = "RGAPI-ae5fe660-78b2-4787-8e58-8beb0be6be10"
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        HistoryManager.pushToHistory(History(UserDetailManager.userDetails!!.summonerName, UserDetailManager.userDetails!!.icon))
